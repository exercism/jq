...
[equality operator]: https://jqlang.org/manual/v1.7/#==-!=
[boolean operators]: https://jqlang.org/manual/v1.7/#and-or-not
[comparison operator]: https://jqlang.org/manual/v1.7/#%3E-%3E=-%3C=-%3C
[conditional expression]: https://jqlang.org/manual/v1.7/#if-then-else-end
